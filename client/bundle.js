...
exports.saveMemo = exports.addMemo = exports.fetchMemos = exports.loadMemos = exports.updateCurrentUrl = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _memoServices = __webpack_require__(76);
...
var CURRENT_URL_UPDATE = "CURRENT_URL_UPDATE";
var MEMO_ADD = "MEMO_ADD";
var MEMOS_LOAD = "MEMOS_LOAD";

var updateCurrentUrl = exports.updateCurrentUrl = function updateCurrentUrl(url) {
	return { type: CURRENT_URL_UPDATE, payload: url };
};

var loadMemos = exports.loadMemos = function loadMemos(memos) {
	return { type: MEMOS_LOAD, payload: memos };
};
var fetchMemos = exports.fetchMemos = function fetchMemos() {
	return function (dispatch) {
		(0, _memoServices.getMemos)().then(function (memos) {
			return dispatch(loadMemos(memos));
		});
	};
};

var addMemo = exports.addMemo = function addMemo(memo) {
	return { type: MEMO_ADD, payload: memo };
};
var saveMemo = exports.saveMemo = function saveMemo(_ref) {
	var description = _ref.description,
	    audioUrl = _ref.audioUrl;

	return function (dispatch) {
		(0, _memoServices.createMemo)(description, audioUrl).then(function (res) {
			return dispatch(addMemo(res));
		});
	};
};
...
exports.default = function () {
	...
	switch (action.type) {
		case MEMO_ADD:
			return _extends({}, state, { memos: state.memos.concat(action.payload) });
		case CURRENT_URL_UPDATE:
			return _extends({}, state, { currentUrl: action.payload });
		case MEMOS_LOAD:
			return _extends({}, state, { memos: action.payload });
		default:
			return state;
	}
};
...
var _VoiceMemoList = __webpack_require__(48);

var _VoiceMemoList2 = _interopRequireDefault(_VoiceMemoList);

var _Recorder = __webpack_require__(77);

var _Recorder2 = _interopRequireDefault(_Recorder);

var _MemoForm = __webpack_require__(78);

var _MemoForm2 = _interopRequireDefault(_MemoForm);
	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'main',
				{ className: 'voice-memos-app container' },
				_react2.default.createElement(
					...
					_react2.default.createElement(_VoiceMemoList2.default, null),
					_react2.default.createElement(_MemoForm2.default, null)
				)
			);
		}
	}]);
...
var _memos = __webpack_require__(8);
...
var VoiceMemoList = function (_Component) {
	_inherits(VoiceMemoList, _Component);
	...
	function VoiceMemoList() {
		...
		_classCallCheck(this, VoiceMemoList);
	...
	_createClass(VoiceMemoList, [{
		...
		value: function render() {
			...
			if (this.props.memos) {
				return this.props.memos.map(function (memo, index) {
					return _react2.default.createElement(VoiceMemo, _extends({}, memo, {
						key: index,
						id: index,
						handlePlaybackState: _this2.handlePlaybackState,
						handleEndedState: _this2.handleEndedState
					}));
				});
			} else {
				return _react2.default.createElement(
	...
	return VoiceMemoList;
}(_react.Component);

var VoiceMemo = function VoiceMemo(props) {
	return _react2.default.createElement(
		'li',
		{ className: 'row list-item' },
		_react2.default.createElement(
			'div',
			{ className: 'col-6 information' },
			_react2.default.createElement(
				'span',
...
exports.default = (0, _reactRedux.connect)(function (state) {
	return { memos: state.memos, currentUrl: state.currentUrl };
}, { fetchMemos: _memos.fetchMemos })(VoiceMemoList);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(25), __webpack_require__(67)(module)))
...
var getMemos = exports.getMemos = function getMemos() {
	return fetch('/getAll').then(function (res) {
		return res.json();
	}).catch(function (err) {
...
var createMemo = exports.createMemo = function createMemo(description, audioUrl) {
	return fetch('/add', {
		method: 'POST',
		headers: {
...
var Recorder = function (_Component) {
	...
	function Recorder() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Recorder.__proto__ || Object.getPrototypeOf(Recorder)).call.apply(_ref, [this].concat(args))), _this), _this.handleRecording = function () {
			...
			navigator.mediaDevices.getUserMedia({ audio: true }).then(function (mediaStream) {
				...
				_this.mediaRecorder = _this.mediaRecorder || new MediaRecorder(mediaStream, options);
	...
	_createClass(Recorder, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'section',
				{ className: 'recording-console row' },
				_react2.default.createElement(
					'div',
					{ className: 'col-12' },
					_react2.default.createElement(
						'button',
						{ type: 'button', className: 'record-button', onClick: this.handleRecording },
						_react2.default.createElement('span', { className: 'pulse-button' })
					)
				)
			);
		}
...
exports.default = (0, _reactRedux.connect)(null, { updateCurrentUrl: _memos.updateCurrentUrl })(Recorder);
...
var MemoForm = function (_Component) {
	_inherits(MemoForm, _Component);
	...
	function MemoForm() {
		...
		_classCallCheck(this, MemoForm);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MemoForm.__proto__ || Object.getPrototypeOf(MemoForm)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (event) {
			event.preventDefault();
			var newMemo = {
				description: $('.input-description').val(),
				audioUrl: _this.props.currentUrl,
				date: new Date().toLocaleDateString()
			};
			_this.props.saveMemo(newMemo);
			$('.input-description').val('');
			_this.handleModalClose();
		}, _this.handleModalClose = function () {
			$('#voiceMemoModal').modal('toggle');
			$('#voiceMemoModal').on('hidden.bs.modal', function () {
				_this.props.updateCurrentUrl('');
				$('.current-audio').attr('src', '');
			});
		}, _temp), _possibleConstructorReturn(_this, _ret);
	}

	_createClass(MemoForm, [{
		key: 'render',
		value: function render() {

			return _react2.default.createElement(
				'section',
				{ className: 'modal fade', id: 'voiceMemoModal', tabIndex: '-1', role: 'dialog', 'aria-labelledby': 'voiceMemoModal' },
				_react2.default.createElement(
					'section',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('audio', { className: 'current-audio', src: this.props.currentUrl, controls: true })
							)
						),
						_react2.default.createElement(
							'section',
							...
							_react2.default.createElement(
								'div',
								{ className: 'row' },
								_react2.default.createElement('input', { className: 'input-description', type: 'text', name: 'description' })
							),
							_react2.default.createElement(
								'div',
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'button',
										{ type: 'submit', value: 'submit', onClick: this.handleSubmit, className: 'save' },
										'Save'
									)
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'button',
										{ type: 'reset', value: 'reset', onClick: this.handleModalClose, className: 'cancel' },
										'Cancel'
									)
								)
							)
...
exports.default = (0, _reactRedux.connect)(function (state) {
	return { memos: state.memos, currentUrl: state.currentUrl };
}, { saveMemo: _memos.saveMemo, updateCurrentUrl: _memos.updateCurrentUrl })(MemoForm);
...
var _reduxDevtoolsExtension = __webpack_require__(80);
...
var _memos2 = _interopRequireDefault(_memos);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.createStore)(_memos2.default, (0, _reduxDevtoolsExtension.composeWithDevTools)((0, _redux.applyMiddleware)(_reduxThunk2.default)));
