...
var _VoiceMemoList = __webpack_require__(41);

var _VoiceMemoList2 = _interopRequireDefault(_VoiceMemoList);

var _Recorder = __webpack_require__(42);
...
var App = function (_Component) {
	...
	function App() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			_index2.default.get('/getAll').then(function (response) {
				_this.setState({ memos: response.data });
				debugger;
			});
			// fetch('/getAll')
			// 	.then(res => res.json())
			...
			// 	});
		}, _this.updateAudioLink = function (audioUrl) {
			_this.setState({ currentUrl: audioUrl });
		}, _this.handlePlayback = function (e) {
			var audio = new Audio(e.target.src);
			audio.play();
		...
		value: function render() {
			...
			var HomePage = function HomePage(props) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Recorder2.default, { updateAudioLink: _this2.updateAudioLink }),
					_react2.default.createElement(_VoiceMemoList2.default, props),
					_react2.default.createElement(_Modal2.default, _extends({}, props, { updateAudioLink: _this2.updateAudioLink }))
				);
			};
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(HomePage, {
	...
	return console.log(props) || _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				"div",
				{ className: "col-9" },
				_react2.default.createElement("audio", { controls: true, src: props.audioUrl, onPlay: props.handlePlayback })
			)
		),
		_react2.default.createElement(
			"div",
...
var VoiceMemoList = function (_Component) {
	...
	function VoiceMemoList() {
		...
		return _possibleConstructorReturn(this, (VoiceMemoList.__proto__ || Object.getPrototypeOf(VoiceMemoList)).apply(this, arguments));
	}
		...
		value: function render() {
			if (this.props.memos) {
				return this.props.memos.map(function (memo, index) {
					return _react2.default.createElement(VoiceMemo, _extends({}, memo, { key: index }));
				});
			} else {
				return _react2.default.createElement(
					"div",
	...
	function Recorder() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Recorder.__proto__ || Object.getPrototypeOf(Recorder)).call.apply(_ref, [this].concat(args))), _this), _this.handleRecording = function () {
			...
			navigator.mediaDevices.getUserMedia({ audio: true }).then(function (mediaStream) {
				var audioChunks = [];
				var options = { mimType: 'audio/webm' };
				...
				_this.mediaRecorder.addEventListener("dataavailable", function (event) {
					...
					_this.props.updateAudioLink(_this.audioUrl);
					document.querySelector("audio").src = _this.audioUrl;
				});
	...
	_createClass(Recorder, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#voiceMemoModal', className: 'done hidden' },
					'Done'
				)
			);
		}
...
var Modal = function (_Component) {
	...
	function Modal() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Modal.__proto__ || Object.getPrototypeOf(Modal)).call.apply(_ref, [this].concat(args))), _this), _this.handleSave = function (e) {
			e.preventDefault();

			_axios2.default.post('/add', _queryString2.default.stringify({
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { className: 'description', type: 'text', name: 'description' }),
							_react2.default.createElement(
								'button',
								{ onClick: this.handleSave, className: 'save' },
								'Save'
							)
						),
						_react2.default.createElement(
